...
<!--        </svg>-->
        <img style="width: 142px;height: 40px;fill: currentColor; margin-top: 55px" :src="logoPng" />
        <p class="logo-content">
          Innochain Blockchain Application Software Extension
        </p>
      </div>
...
import logo from "@/../static/image/inno-logo.png";
